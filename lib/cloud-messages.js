...
module.exports.sendCloudMessage = function sendCloudMessage(options, next) {
  ...
  if (options.serialNumber) {
    message.serialNum = options.serialNumber;
  }
...
/**
 * Send payment bridge message to device
 * @param {String} options.businessId
 * @param {String} options.storeId
 * @param {String} options.deviceId
 * @param {String} options.serialNumber
 ...
 * @param {String} options.ttl (optional) - defaults to 900 seconds or 15 min
 */
module.exports.sendPaymentBridgeMessage = function sendPaymentBridgeMessage(options, next) {
  var hasErr = helpers.hasKeys(options, ['businessId', 'storeId', 'deviceId', 'data']);
  if (hasErr) {
    return next(hasErr);
  }
