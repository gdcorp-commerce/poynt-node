 ...
 * @param {String} options.partialAuthEnabled - whether partial auth is enabled (optional). Defaults to true
 */
module.exports.chargeToken = function (options, next) {
  ...
  if (typeof options.partialAuthEnabled !== "undefined") {
    body.partialAuthEnabled = options.partialAuthEnabled;
  }
  if (options.phone) {
    body.receiptPhone = {
